 ...
 * @author AFMireski
 */
@WebServlet(name = "clearLojaFilterServlet", urlPatterns = {"/clearLojaFilterServlet"})
public class clearLojaFilterServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session != null && session.getId().equals((String) session.getAttribute("sisID"))) {
            ...
            session.setAttribute("lojaSearch", null);
