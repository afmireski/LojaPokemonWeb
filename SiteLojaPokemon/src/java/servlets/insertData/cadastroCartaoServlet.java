 ...
 * @author aacor
 */
@WebServlet(name = "cadastroCartaoServlet", urlPatterns = {"/cadastroCartaoServlet"})
public class cadastroCartaoServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet cadastroCartaoServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet cadastroCartaoServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (session != null && session.getId().equals(session.getAttribute("sisID"))) {
            try {
                ...
                Double txtSaldo = Double.valueOf(request.getParameter("txtSaldo"));
